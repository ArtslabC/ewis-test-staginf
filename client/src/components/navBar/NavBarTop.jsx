...
function NavBarTop() {
  ...
  return (
    <>
      <header className="sticky top-0 bg-red z-50 transition duration-1000 ease-in-out">
        <nav
          className="mx-auto flex max-w-screen-xl items-center justify-between py-4 px-8"
          aria-label="Global"
        >
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  <Link
                    to="/"
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 group-hover:text-primary hover:bg-primarygray"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Buy EWIS
                  </Link>
