    ...
    <>
      <Suspense fallback={<LoadingScreen />}>
        <div className="w-screen h-screen relative">
          {currentStage !== 0 && (
            <div
              className={`fixed z-50 transition-transform duration-300 ease-in-out bg-white shadow-lg ${
                currentStage !== 0 ? "-translate-x-0" : "-translate-x-full"
              } md:${
                currentStage !== 0 ? "translate-x-0" : "translate-x-full"
